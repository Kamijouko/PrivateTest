...
さらに下の**RimSpine2DFramework**には、私が開発した **Spine2D レンダリングフレームワーク** が含まれています。  
...
私のフレームワークでは RimWorld のストーリーテラー (Story Teller) に Spine2D の動的演出を追加しており、  
...
次に、右上のボタンをクリックしてキャラクターエディターを閉じ、マップ上の他のキャラクターの動作を確認してください。  
一部のキャラクターはアニメーション表現を持っています。  
